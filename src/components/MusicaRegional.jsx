    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Música Regional (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Ritmos únicos como carimbó, lambada e brega paraense<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Região Norte</span>
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre a Música</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                A música regional amazônica é uma rica expressão cultural que mescla 
                influências indígenas, africanas e europeias. Ritmos como carimbó, 
                lambada, brega paraense e guitarrada retratam a vida ribeirinha, 
                o amor pela natureza e as tradições locais, criando uma identidade 
                musical única da região Norte.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            A música regional amazônica tem raízes profundas na miscigenação cultural. 
            O carimbó surgiu no século XVII, misturando tambores africanos com melodias 
            indígenas. A lambada ganhou fama mundial nos anos 80, enquanto o brega 
            paraense conquistou o Norte do país. Cada ritmo conta histórias do cotidiano 
            ribeirinho e celebra a identidade amazônica.
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Onde Ouvir</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Festivais regionais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Casas de show</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Festas populares</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Principais Ritmos</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Carimbó</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Lambada</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Brega paraense</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Instrumentos</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Tambores</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Guitarra</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Maracás</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Participe das danças</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Conheça os artistas locais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Visite durante festivais</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Carimbó', desc: 'Patrimônio Cultural Imaterial do Brasil' },
              { title: 'Lambada', desc: 'Conquistou o mundo nos anos 80' },
              { title: 'Brega Paraense', desc: 'Fenômeno musical do Norte' },
              { title: 'Guitarrada', desc: 'Som característico da guitarra' },
              { title: 'Influências', desc: 'Mistura indígena, africana e europeia' },
              { title: 'Identidade', desc: 'Expressa a alma amazônica' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
