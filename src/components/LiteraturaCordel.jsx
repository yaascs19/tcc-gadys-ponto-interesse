    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Literatura de Cordel (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Tradição poética que narra histórias e lendas amazônicas<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Feiras e Mercados</span>
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre o Cordel</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                A literatura de cordel amazônica é uma forma de expressão poética popular 
                que narra histórias, lendas e acontecimentos da região através de versos 
                rimados. Os folhetos ilustrados com xilogravuras preservam a memória 
                cultural, contando desde lendas do Curupira e Boto até crônicas do 
                cotidiano ribeirinho e grandes acontecimentos regionais.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O cordel chegou à Amazônia através dos migrantes nordestinos no século XIX, 
            adaptando-se às temáticas locais. Os cordelistas amazônicos criaram um estilo 
            único, incorporando lendas indígenas, histórias ribeirinhas e a rica mitologia 
            da floresta. Os folhetos eram vendidos em feiras e mercados, pendurados em 
            cordões, daí o nome "literatura de cordel".
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Feiras populares</li>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Temas Principais</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Lendas amazônicas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Vida ribeirinha</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Acontecimentos regionais</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Versos rimados</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Xilogravuras</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Linguagem popular</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Converse com os cordelistas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Valorize a arte popular</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Colecione os folhetos</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Xilogravura', desc: 'Ilustrações feitas em madeira' },
              { title: 'Métrica', desc: 'Versos de sete sílabas poéticas' },
              { title: 'Oralidade', desc: 'Tradição oral preservada' },
              { title: 'Temática', desc: 'Lendas e histórias regionais' },
              { title: 'Patrimônio', desc: 'Reconhecido pela UNESCO' },
              { title: 'Resistência', desc: 'Mantém viva a cultura popular' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
...
export default LiteraturaCordel