    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Palácio Rio Negro (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            De residência dos governadores a centro cultural<br />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Palácio Rio Negro foi construído em 1903 como residência oficial dos governadores do Amazonas. 
                Localizado no centro de Manaus, o palácio é um exemplo da arquitetura eclética do início do século XX. 
                Atualmente funciona como centro cultural, abrigando exposições, eventos e atividades artísticas, 
                preservando a memória histórica do estado.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            Construído durante o período áureo da borracha, o Palácio Rio Negro serviu como residência oficial 
            dos governadores do Amazonas por décadas. Sua arquitetura reflete a prosperidade da época, 
            com influências europeias adaptadas ao clima tropical. Em 1997, foi transformado em centro cultural, 
            democratizando o acesso a este importante patrimônio histórico amazonense.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Exposições temporárias</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Eventos especiais</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Terça a Domingo: 9h às 17h</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Segunda: Fechado</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Feriados: Consultar</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Visite as exposições</li>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Construção', desc: 'Construído em 1903 durante o ciclo da borracha' },
              { title: 'Função Original', desc: 'Residência oficial dos governadores do Amazonas' },
              { title: 'Arquitetura', desc: 'Estilo eclético com influências europeias' },
              { title: 'Centro Cultural', desc: 'Transformado em espaço cultural em 1997' },
              { title: 'Exposições', desc: 'Abriga mostras de arte e história regional' },
              { title: 'Patrimônio', desc: 'Importante marco da arquitetura manauara' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
...
export default PalacioRioNegro