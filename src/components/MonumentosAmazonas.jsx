...
function MonumentosAmazonas() {
  ...
  const monumentos = [
    ...
    {
      nome: 'Casa de Ópera',
      desc: 'Anexo do Teatro Amazonas com exposições culturais',
      detalhes: 'Espaço cultural que complementa o complexo do Teatro Amazonas',
      img: '/opera.jpeg',
...
export default MonumentosAmazonas