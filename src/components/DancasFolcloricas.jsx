    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Danças Folclóricas (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Manifestações culturais como quadrilha, carimbó e sirimbó<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Festivais Regionais</span>
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre as Danças</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                As danças folclóricas amazônicas são expressões culturais que celebram 
                tradições e festividades regionais. O carimbó, sirimbó, quadrilha junina 
                e outras manifestações retratam a alegria do povo amazônico, misturando 
                movimentos que imitam a natureza com ritmos contagiantes que animam 
                festivais e celebrações comunitárias.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            As danças folclóricas amazônicas têm origem na fusão de tradições indígenas, 
            africanas e europeias. O carimbó surgiu no século XVII como dança de terreiro, 
            enquanto o sirimbó representa a cultura cabocla. As quadrilhas juninas chegaram 
            com os colonizadores e ganharam características regionais únicas, incorporando 
            elementos da fauna e flora amazônicas nos movimentos e coreografias.
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Onde Ver</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Festivais juninos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Centros culturais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Apresentações folclóricas</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Principais Danças</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Carimbó</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Sirimbó</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Quadrilha junina</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Movimentos da natureza</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Roupas coloridas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Participação coletiva</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Participe das rodas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Aprenda os passos básicos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Respeite as tradições</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Carimbó', desc: 'Dança de roda com sapateado' },
              { title: 'Sirimbó', desc: 'Representa a cultura cabocla' },
              { title: 'Quadrilha', desc: 'Adaptada com elementos regionais' },
              { title: 'Vestimentas', desc: 'Saias rodadas e camisas coloridas' },
              { title: 'Instrumentos', desc: 'Tambores, maracás e sanfona' },
              { title: 'Tradição', desc: 'Patrimônio cultural imaterial' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
...
export default DancasFolcloricas