    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Encontro das Águas (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Fenômeno natural único na Amazônia<br />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Encontro das Águas é um fenômeno natural onde os rios Negro e Solimões correm lado a lado 
                por cerca de 6 quilômetros sem se misturar. As águas escuras do Rio Negro contrastam com 
                as águas barrentas do Rio Solimões, criando um espetáculo único da natureza que pode ser 
                observado próximo a Manaus.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O fenômeno ocorre devido às diferentes características físicas e químicas dos dois rios. 
            O Rio Negro possui águas escuras e ácidas, com temperatura mais elevada e menor velocidade, 
            enquanto o Rio Solimões tem águas barrentas, mais densas e frias. Essa diferença impede 
            a mistura imediata, criando uma fronteira natural visível entre as águas.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Barco do Porto de Manaus</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Tour guiado</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Lancha rápida</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Tour: R$ 120,00</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Criança: R$ 60,00</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Grupo: Desconto</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Diariamente: 8h às 16h</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Duração: 3-4 horas</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Câmera fotográfica</li>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Extensão', desc: 'O fenômeno se estende por cerca de 6 quilômetros' },
              { title: 'Temperatura', desc: 'Rio Negro: 28°C, Rio Solimões: 22°C' },
              { title: 'Velocidade', desc: 'Diferentes velocidades impedem a mistura imediata' },
              { title: 'Cor', desc: 'Negro: águas escuras, Solimões: águas barrentas' },
              { title: 'pH', desc: 'Rio Negro é mais ácido que o Rio Solimões' },
              { title: 'Formação', desc: 'Após 6km formam o Rio Amazonas' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
