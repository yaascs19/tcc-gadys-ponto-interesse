    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Tucumã (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Palmito amazônico rico em vitaminas<br />
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre o Tucumã</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O tucumã é o fruto da palmeira tucumanzeiro, muito apreciado na 
                região amazônica. Rico em vitamina A, óleos essenciais e fibras, 
                possui polpa oleosa de cor alaranjada e sabor característico. 
                É consumido in natura, em sucos, doces ou como acompanhamento 
                de pratos típicos, sendo especialmente popular no café da manhã 
                dos amazonenses.
              </p>
            </div>
          </div>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O tucumã é consumido pelos povos indígenas amazônicos há séculos, 
            sendo considerado alimento sagrado por algumas etnias. O nome deriva 
            da língua tupi e significa "fruto espinhoso". Durante o período colonial, 
            tornou-se popular entre os ribeirinhos e hoje é parte essencial da 
            culinária regional, especialmente no estado do Amazonas, onde é 
            tradicionalmente consumido no café da manhã.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Feiras matinais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Mercados regionais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Vendedores de rua</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Formas de Consumo</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>In natura com farinha</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Vitaminas e sucos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Doces e geleias</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Benefícios</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Rico em vitamina A</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Óleos essenciais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Fonte de fibras</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Consuma pela manhã</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Acompanhe com café</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Experimente com farinha</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Palmeira', desc: 'Fruto da palmeira tucumanzeiro' },
              { title: 'Vitamina A', desc: 'Excelente fonte de betacaroteno' },
              { title: 'Tradição', desc: 'Consumido no café da manhã' },
              { title: 'Origem', desc: 'Nome vem do tupi "fruto espinhoso"' },
              { title: 'Cor', desc: 'Polpa alaranjada característica' },
              { title: 'Sustentabilidade', desc: 'Colheita não prejudica a palmeira' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
