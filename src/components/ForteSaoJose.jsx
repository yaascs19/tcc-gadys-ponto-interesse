    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Forte São José (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Marco da colonização portuguesa na Amazônia<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Rio Negro - AM</span>
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Forte de São José da Barra do Rio Negro foi construído em 1669 pelos portugueses para 
                defender a região dos invasores holandeses e estabelecer o domínio português na Amazônia. 
                Localizado na confluência dos rios Negro e Solimões, marca o início da colonização 
                portuguesa na região que hoje é Manaus.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            Construído pelo capitão-mor Pedro da Costa Favela em 1669, o forte foi estrategicamente posicionado 
            para controlar o acesso aos rios Negro e Solimões. Durante o século XVII, serviu como base militar 
            e ponto de partida para expedições de reconhecimento do território amazônico. O forte foi fundamental 
            para estabelecer a presença portuguesa na região e garantir o controle sobre as rotas fluviais.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Tour guiado</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Tour: R$ 80,00</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Estudante: R$ 40,00</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Grupo: Consultar</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Terça a Domingo: 8h às 16h</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Agende com antecedência</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Leve repelente</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Calçado adequado</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Primeiro Forte', desc: 'Primeira fortificação portuguesa construída na Amazônia' },
              { title: 'Localização', desc: 'Estrategicamente posicionado na confluência dos rios' },
              { title: 'Defesa', desc: 'Protegia contra invasões holandesas e francesas' },
              { title: 'Origem de Manaus', desc: 'Marco inicial da futura cidade de Manaus' },
              { title: 'Arquitetura', desc: 'Construção típica militar portuguesa do século XVII' },
              { title: 'Patrimônio', desc: 'Tombado como patrimônio histórico nacional' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
