    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Açaí (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Superfruta energética da Amazônia<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Pará - AM</span>
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre o Açaí</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O açaí é uma das frutas mais emblemáticas da Amazônia, sendo base 
                da alimentação ribeirinha há séculos. Rico em antioxidantes, vitaminas 
                e minerais, é consumido tanto doce quanto salgado. Na região Norte, 
                é tradicionalmente servido com farinha de mandioca, peixe ou camarão, 
                enquanto no resto do Brasil ganhou fama como sobremesa energética.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O açaí é consumido pelos povos indígenas amazônicos há mais de mil anos. 
            Segundo a lenda, uma índia chamada Iaçá deu origem ao nome da fruta. 
            Para os ribeirinhos, o açaí é alimento sagrado e base nutricional. 
            Nas últimas décadas, ganhou reconhecimento mundial como superalimento, 
            sendo exportado para diversos países como símbolo da biodiversidade amazônica.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Açaizeiros tradicionais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Feiras do açaí</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Açaí salgado com farinha</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Açaí doce com frutas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Vitaminas e smoothies</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Alto valor energético</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Rico em antioxidantes</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Fonte de ômega 3</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Experimente o açaí salgado</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Consuma fresco</li>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Lenda', desc: 'Nome deriva da índia Iaçá' },
              { title: 'Superalimento', desc: 'Reconhecido mundialmente' },
              { title: 'Tradição', desc: 'Base da alimentação ribeirinha' },
              { title: 'Versatilidade', desc: 'Consumido doce e salgado' },
              { title: 'Energia', desc: 'Alto valor calórico natural' },
              { title: 'Sustentabilidade', desc: 'Colheita preserva a palmeira' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
