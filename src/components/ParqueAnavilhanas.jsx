    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Parque Anavilhanas (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Maior arquipélago fluvial do mundo<br />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Parque Nacional de Anavilhanas é o maior arquipélago fluvial do mundo, 
                formado por mais de 400 ilhas no Rio Negro. Com 350 mil hectares, 
                o parque abriga uma rica biodiversidade aquática e terrestre, 
                sendo um dos principais destinos de ecoturismo da Amazônia.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            Criado em 1981, o Parque Nacional de Anavilhanas foi estabelecido para proteger 
            o maior arquipélago fluvial do mundo. O nome "Anavilhanas" deriva da palavra indígena 
            que significa "ilha das onças". Durante a época da seca, entre setembro e janeiro, 
            as ilhas ficam mais visíveis, revelando praias de areia branca e formações rochosas únicas.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>120 km de Manaus</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Barco ou lancha</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Melhor Época</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Setembro a janeiro</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Época da seca</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Praias visíveis</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Trilhas aquáticas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Camping nas ilhas</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Autorização do ICMBio</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Guia credenciado</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Equipamentos aquáticos</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Arquipélago', desc: 'Maior arquipélago fluvial do mundo' },
              { title: 'Ilhas', desc: 'Mais de 400 ilhas no Rio Negro' },
              { title: 'Área', desc: '350 mil hectares protegidos' },
              { title: 'Botos', desc: 'Habitat dos botos-cor-de-rosa' },
              { title: 'Praias', desc: 'Praias de areia branca na seca' },
              { title: 'Criação', desc: 'Parque Nacional desde 1981' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
...
export default ParqueAnavilhanas