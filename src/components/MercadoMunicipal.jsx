    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Mercado Municipal (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Inspirado no mercado de Les Halles de Paris<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Porto de Manaus - AM</span>
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Mercado Municipal Adolpho Lisboa é um mercado histórico localizado no centro de Manaus, 
                construído em 1882. Inspirado no famoso mercado de Les Halles de Paris, 
                é um dos principais pontos turísticos da cidade e um importante centro de 
                comércio de produtos regionais amazônicos.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            Inaugurado em 1882 durante o período áureo da borracha, o mercado foi projetado pelo 
            engenheiro português Henrique Antônio Lisboa. Sua estrutura de ferro foi importada da Europa, 
            seguindo o modelo arquitetônico do mercado de Les Halles de Paris. 
            O mercado tornou-se um símbolo da prosperidade econômica de Manaus no final do século XIX.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Próximo ao Porto</li>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Produtos</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Peixes amazônicos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Frutas regionais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Artesanato local</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Segunda a Sábado: 5h às 18h</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Domingo: 5h às 12h</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Melhor horário: manhã</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Vá pela manhã</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Prove os sucos regionais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Negocie os preços</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Inspiração', desc: 'Baseado no mercado de Les Halles de Paris' },
              { title: 'Estrutura', desc: 'Ferro importado da Europa no século XIX' },
              { title: 'Nome', desc: 'Homenagem ao engenheiro Adolpho Lisboa' },
              { title: 'Produtos', desc: 'Maior variedade de peixes da Amazônia' },
              { title: 'Patrimônio', desc: 'Tombado como patrimônio histórico' },
              { title: 'Turismo', desc: 'Um dos pontos turísticos mais visitados' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
...
export default MercadoMunicipal