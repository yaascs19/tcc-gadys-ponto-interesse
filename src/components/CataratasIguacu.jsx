      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Uma das maiores quedas d'água do mundo<br />
            <span style={{ color: '#667eea', fontWeight: '500' }}>Foz do Iguaçu - PR</span>
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                As Cataratas do Iguaçu são um conjunto de cerca de 275 quedas d'água no Rio Iguaçu, 
                localizadas entre o Parque Nacional do Iguaçu (Brasil) e o Parque Nacional Iguazú (Argentina). 
                Consideradas Patrimônio Natural da Humanidade pela UNESCO, as cataratas oferecem um dos 
                espetáculos naturais mais impressionantes do mundo.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            As Cataratas do Iguaçu foram descobertas pelo explorador espanhol Álvar Núñez Cabeza de Vaca em 1541. 
            O nome "Iguaçu" tem origem guarani e significa "água grande". O Parque Nacional do Iguaçu foi criado em 1939 
            no Brasil e em 1934 na Argentina, sendo declarado Patrimônio Mundial da UNESCO em 1984 (Argentina) e 1986 (Brasil).
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Aeroporto de Foz do Iguaçu</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Ônibus urbano até o parque</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Carro próprio ou alugado</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Criança (2-11 anos): R$ 13,00</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Diariamente: 9h às 17h</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Trilha: 1h30 de caminhada</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Última entrada: 16h</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Use calçado antiderrapante</li>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              ...
              { title: 'Patrimônio UNESCO', desc: 'Declarado Patrimônio Natural da Humanidade em 1984/1986' },
              { title: 'Biodiversidade', desc: 'Abriga mais de 2000 espécies de plantas vasculares' },
              { title: 'Arco-íris', desc: 'É possível ver arco-íris duplos nos dias ensolarados' },
              { title: 'Dois Países', desc: 'As cataratas ficam na fronteira entre Brasil e Argentina' },
              { title: 'Volume de Água', desc: 'Despeja cerca de 1.756 m³ de água por segundo' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
