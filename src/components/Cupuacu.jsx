    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Cupuaçu (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Fruta exótica com sabor único<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Amazônia</span>
          </p>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre o Cupuaçu</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O cupuaçu é uma fruta amazônica da família do cacau, considerada 
                uma das mais saborosas da região. Sua polpa cremosa e aromática 
                possui sabor único, entre doce e ácido, sendo muito apreciada 
                in natura ou em doces, sucos, sorvetes e sobremesas. É rico em 
                vitaminas e antioxidantes, sendo chamado de "fruto dos deuses".
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O cupuaçu é nativo da Amazônia e era consumido pelos povos indígenas 
            muito antes da chegada dos europeus. Seu nome deriva da palavra tupi 
            "kupu'asu", que significa "fruto grande". Durante séculos, foi alimento 
            básico das populações ribeirinhas. Hoje, é considerado um superfruto 
            e ganhou reconhecimento mundial por suas propriedades nutritivas.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Mercados locais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Sorveteiras artesanais</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Polpa in natura</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Sucos e vitaminas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Sorvetes e doces</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Rico em vitamina C</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Antioxidantes naturais</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Fibras e minerais</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Experimente gelado</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Prove diferentes preparos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Combine com outras frutas</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Família', desc: 'Parente próximo do cacau' },
              { title: 'Superfruto', desc: 'Rico em antioxidantes' },
              { title: 'Sabor', desc: 'Único, entre doce e ácido' },
              { title: 'Origem', desc: 'Nome vem do tupi "kupu\'asu"' },
              { title: 'Versatilidade', desc: 'Usado em doces e salgados' },
              { title: 'Sustentabilidade', desc: 'Cultivo ecológico na Amazônia' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
