      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Cartão postal do Rio de Janeiro<br />
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Pão de Açúcar é um complexo de morros localizado na Urca, com 396 metros de altura. 
                Famoso mundialmente, oferece uma das vistas mais espetaculares do Rio de Janeiro. 
                O acesso é feito através de um sistema de bondinhos que conecta três estações: 
                Praia Vermelha, Morro da Urca e Pão de Açúcar.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O nome "Pão de Açúcar" tem origem portuguesa e se refere ao formato cônico do morro, 
            semelhante aos pães de açúcar refinado da época colonial. O bondinho foi inaugurado em 1912, 
            sendo o terceiro teleférico do mundo e o primeiro do Brasil. Desde então, tornou-se um dos 
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Metrô: Estação Botafogo + ônibus</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Táxi/Uber até a Urca</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Carro: Estacionamento na Urca</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Adulto: R$ 120,00</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Criança (6-12 anos): R$ 60,00</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Idoso (+60): R$ 60,00</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Diariamente: 8h às 19h50</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Bondinho: A cada 20 minutos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Última subida: 19h30</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Vá no final da tarde</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Compre online com desconto</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Leve câmera fotográfica</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Bondinho Histórico', desc: 'Terceiro teleférico do mundo, inaugurado em 1912' },
              { title: 'Vista Panorâmica', desc: 'Vista 360° da cidade, praias e montanhas' },
              { title: 'Pôr do Sol', desc: 'Um dos melhores locais para assistir o pôr do sol no Rio' },
              { title: 'Escalada', desc: 'Destino mundial para escalada em rocha' },
              { title: 'Cinema', desc: 'Cenário de filmes famosos como 007 e Velozes e Furiosos' },
              { title: 'Geologia', desc: 'Formação rochosa de gnaisse com mais de 600 milhões de anos' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
