    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Tacaçá (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Prato típico com tucumã e camarão seco<br />
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              <h2 style={{ fontSize: '2.5rem', marginBottom: '2rem', fontWeight: '700' }}>Sobre o Tacaçá</h2>
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O tacaçá é um dos pratos mais emblemáticos da culinária amazônica. 
                Servido tradicionalmente em cuias, é uma sopa quente feita com goma 
                de mandioca brava (tucumã), jambu, camarão seco e caldo de peixe. 
                O jambu proporciona uma sensação única de dormência na boca, 
                característica marcante desta iguaria regional.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O tacaçá tem origem indígena e foi adaptado durante o período colonial. 
            A receita foi passada de geração em geração pelas tacacazeiras, mulheres 
            que tradicionalmente preparam e vendem o prato nas ruas de Manaus e Belém. 
            O nome deriva da palavra tupi "tacacá", que significa "refogado quente". 
            É considerado patrimônio cultural imaterial da região Norte.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Tacacazeiras de rua</li>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Ingredientes</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Goma de mandioca</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Jambu</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Camarão seco</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Melhor Horário</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Final da tarde</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Início da noite</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Dias chuvosos</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Coma bem quente</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Use colher de pau</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Experimente a sensação do jambu</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Jambu', desc: 'Causa dormência na boca e língua' },
              { title: 'Cuia', desc: 'Servido tradicionalmente em cuias' },
              { title: 'Tacacazeiras', desc: 'Vendedoras tradicionais de rua' },
              { title: 'Patrimônio', desc: 'Patrimônio cultural imaterial' },
              { title: 'Origem', desc: 'Receita de origem indígena' },
              { title: 'Ritual', desc: 'Consumido como ritual de boas-vindas' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
