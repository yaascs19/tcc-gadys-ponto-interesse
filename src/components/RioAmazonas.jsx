    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Rio Amazonas (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            O maior rio do mundo em volume de água<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Amazonas - AM</span>
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                O Rio Amazonas é o maior rio do mundo em volume de água, com aproximadamente 
                6.400 quilômetros de extensão. Nasce nos Andes peruanos e deságua no Oceano 
                Atlântico, atravessando toda a região amazônica. É considerado a principal 
                artéria fluvial da floresta, essencial para a vida de milhões de pessoas 
                e para o ecossistema amazônico.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            O Rio Amazonas foi formado há milhões de anos e tem sido fundamental para o desenvolvimento 
            da região amazônica. Foi descoberto pelos europeus em 1500 por Vicente Yáñez Pinzón, 
            mas recebeu seu nome atual em homenagem às guerreiras amazonas da mitologia grega, 
            após o explorador Francisco de Orellana relatar ter encontrado mulheres guerreiras 
            em suas margens durante sua expedição em 1542.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Porto de Manaus</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Barcos e lanchas</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Cruzeiros fluviais</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <h3 style={{ fontSize: '1.5rem', marginBottom: '1.5rem', color: '#4caf50', fontWeight: '600' }}>Navegação</h3>
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Transporte regional</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Turismo fluvial</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Observação de botos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Pesca de tucunaré</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Passeios de canoa</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Protetor solar</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Chapéu e óculos</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Guia local</li>
              </ul>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Extensão', desc: '6.400 km de comprimento total' },
              { title: 'Volume', desc: 'Maior rio do mundo em volume de água' },
              { title: 'Largura', desc: 'Até 50 km de largura na foz' },
              { title: 'Afluentes', desc: 'Mais de 1.100 afluentes' },
              { title: 'Peixes', desc: 'Mais de 3.000 espécies de peixes' },
              { title: 'Nascente', desc: 'Nasce nos Andes peruanos' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
