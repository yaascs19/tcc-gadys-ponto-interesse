    ...
    <div style={{
      ...
      <header style={{
        ...
        >
          ...
          <li><a href="#" style={{ color: '#ccc', textDecoration: 'none', padding: '0.5rem 1rem', cursor: 'not-allowed' }}>Igreja São Sebastião (atual)</a></li>
      ...
      <main style={{
        ...
        <section style={{
          ...
          <p style={{
            ...
            Marco da colonização religiosa amazônica<br />
            <span style={{ color: '#4caf50', fontWeight: '500' }}>Centro Histórico de Manaus - AM</span>
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '4rem', alignItems: 'center' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem' }}>
                A Igreja de São Sebastião é uma das igrejas mais antigas de Manaus, construída no século XVIII. 
                Localizada no centro histórico da cidade, representa um importante marco da colonização 
                religiosa na região amazônica e mantém viva a tradição católica local, 
                sendo dedicada ao santo protetor contra as epidemias.
              </p>
            </div>
          </div>
        </section>
        ...
        <section style={{
          ...
          <p style={{ fontSize: '1.2rem', lineHeight: 1.8, opacity: 0.9, marginBottom: '2rem', textAlign: 'center', maxWidth: '900px', margin: '0 auto 2rem' }}>
            Construída no século XVIII pelos missionários católicos, a Igreja de São Sebastião foi erguida 
            como parte do processo de evangelização da região amazônica. A escolha de São Sebastião como 
            padroeiro reflete a preocupação com as epidemias que frequentemente assolavam a região. 
            A igreja testemunhou o crescimento de Manaus desde seus primórdios até se tornar uma metrópole.
          </p>
        </section>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(2, 1fr)', gap: '3rem' }}>
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Centro Histórico</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Transporte público</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Caminhada do centro</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Entrada gratuita</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Respeitar horários de missa</li>
            ...
            <div style={{
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Diariamente: 6h às 18h</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Missas: Consultar paróquia</li>
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Festividades especiais</li>
              </ul>
            </div>
            <div style={{
              background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
              ...
              <ul style={{ listStyle: 'none', padding: 0, margin: 0 }}>
                ...
                <li style={{ marginBottom: '1rem', fontSize: '1.1rem' }}>Respeite o silêncio</li>
        ...
        <section style={{
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '2rem' }}>
            {[
              { title: 'Antiguidade', desc: 'Uma das igrejas mais antigas de Manaus' },
              { title: 'São Sebastião', desc: 'Santo protetor contra epidemias e pestes' },
              { title: 'Arquitetura', desc: 'Estilo colonial português adaptado ao clima' },
              { title: 'Localização', desc: 'Centro histórico da cidade de Manaus' },
              { title: 'Tradição', desc: 'Mantém viva a fé católica na região' },
              { title: 'Patrimônio', desc: 'Parte do patrimônio religioso amazonense' }
            ].map((item, index) => (
              <div key={index} style={{
                background: darkMode ? 'rgba(255,255,255,0.05)' : 'rgba(255,255,255,0.8)',
                padding: '2rem',
...
export default IgrejaSaoSebastiao